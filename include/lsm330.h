...
#define LSM330_ACC_OFFSET_ADDR			0x50
#define LSM330_ACC_OFFSET_X_DEAFULT_VALUE	0
#define LSM330_ACC_OFFSET_Y_DEAFULT_VALUE	0
#define LSM330_ACC_OFFSET_Z_DEAFULT_VALUE	-20

int lsm330_gyro_get_enable(void);
void lsm330_gyro_set_enable(int en);
