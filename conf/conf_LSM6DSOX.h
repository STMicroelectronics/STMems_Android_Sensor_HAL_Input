 ...
 * Mario Tesi - Motion MEMS Product Div.
...
#ifndef CONFIGURATION_LSM6DSOX_H
#define CONFIGURATION_LSM6DSOX_H
...
#define SENSOR_ACC_LABEL			"LSM6DSOX 3-axis Accelerometer Sensor"	// Label views in Android Applications
#define SENSOR_DATANAME_ACCELEROMETER		"ST LSM6DSOX Accelerometer Sensor"	// Name of input device: struct input_dev->name
...
/* GYROSCOPE SENSOR */
#define SENSOR_GYRO_LABEL			"LSM6DSOX 3-axis Gyroscope sensor"	// Label views in Android Applications
#define SENSOR_DATANAME_GYROSCOPE		"ST LSM6DSOX Gyroscope Sensor"		// Name of input device: struct input_dev->name
...
/* TILT SENSOR */
#define SENSOR_TILT_LABEL			"LSM6DSOX Tilt Detector sensor"		// Label views in Android Applications
#define SENSOR_DATANAME_TILT			"ST LSM6DSOX Tilt Sensor"		// Name of input device: struct input_dev->name
...
/* STEP COUNTER SENSOR */
#define SENSOR_STEP_C_LABEL			"LSM6DSOX Step Counter sensor"		// Label views in Android Applications
#define SENSOR_DATANAME_STEP_C			"ST LSM6DSOX Step Counter Sensor"	// Name of input device: struct input_dev->name
...
#define SENSOR_STEP_D_LABEL			"LSM6DSOX Step Detector Sensor"		// Label views in Android Applications
#define SENSOR_DATANAME_STEP_D			"ST LSM6DSOX Step Detector Sensor"	// Name of input device: struct input_dev->name
...
#define SENSOR_SIGN_M_LABEL			"LSM6DSOX Significant Motion Sensor"	// Label views in Android Applications
#define SENSOR_DATANAME_SIGN_M			"ST LSM6DSOX Significant Motion Sensor"	// Name of input device: struct input_dev->name
...
#endif	/* CONFIGURATION_LSM6DSOX_H */
