...
#define SENSOR_ACC_LABEL			"LIS2HH 3-axis Accelerometer Sensor"	// Label views in Android Applications
#define SENSOR_DATANAME_ACCELEROMETER		"lis2hh"				// Name of input device: struct input_dev->name
