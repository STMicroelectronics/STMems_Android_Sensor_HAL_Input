...
#define SENSORS_VIRTUAL_GYROSCOPE_ENABLE	(0 && SENSORS_ACCELEROMETER_ENABLE && SENSORS_MAGNETIC_FIELD_ENABLE && !SENSORS_GYROSCOPE_ENABLE && GEOMAG_FUSION_MODULE_PRESENT)
