...
#define SENSORS_VIRTUAL_GYROSCOPE_ENABLE	(0 & SENSORS_ACCELEROMETER_ENABLE & SENSORS_MAGNETIC_FIELD_ENABLE & !SENSORS_GYROSCOPE_ENABLE)
#define SENSORS_UNCALIB_GYROSCOPE_ENABLE	(0)

#define SENSOR_VIRTUAL_GYRO_LABEL		"STMicroelectronics Gyroscope sensor"
#define VIRTUAL_GYRO_MAX_RANGE			(8 * GRAVITY_EARTH)
