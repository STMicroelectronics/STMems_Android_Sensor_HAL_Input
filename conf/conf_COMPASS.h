...
// ST compass Enable
#define SENSORS_COMPASS_ORIENTATION_ENABLE	(1 & NEWCOMPASS_MODULE_PRESENT & SENSORS_MAGNETIC_FIELD_ENABLE & SENSORS_ACCELEROMETER_ENABLE)

#define ORIENTATION_MAX_ODR			(25)
#define COMPASS_LIB_ODR				(25)
