...
#define SENSOR_GYR_INCLUDE_FILE_NAME		"lsm6ds3.h"				// Name of driver header file (include subfolder)
...
#define SENSOR_STEP_D_INCLUDE_FILE_NAME		"lsm6ds3.h"				// Name of driver header file (include subfolder)
