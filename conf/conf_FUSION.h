...
#define SENSORS_GRAVITY_ENABLE			(1 && (REAL_9AXIS_AVAILABLE || VIRTUAL_9AXIS_AVAILABLE) && SENSOR_FUSION_MODULE_PRESENT)
#define SENSORS_LINEAR_ACCELERATION_ENABLE	(1 && (REAL_9AXIS_AVAILABLE || VIRTUAL_9AXIS_AVAILABLE) && SENSOR_FUSION_MODULE_PRESENT)
...
#define SENSORS_GEOMAG_ROTATION_VECTOR_ENABLE	(1 && SENSORS_MAGNETIC_FIELD_ENABLE && SENSORS_ACCELEROMETER_ENABLE && OS_VERSION_ENABLE && GEOMAG_FUSION_MODULE_PRESENT)
