...
#define SENSOR_GYR_INCLUDE_FILE_NAME	"l3gd20.h"				// Name of driver header file (include subfolder)
#define SENSOR_DATANAME_GYROSCOPE	L3GD20_GYR_DEV_NAME			// Name of input device: struct input_dev->name
