...
#ifndef CONFIGURATION_LPS22HH_H
#define CONFIGURATION_LPS22HH_H

#define SENSORS_PRESSURE_ENABLE		(1)
#define SENSORS_TEMP_PRESS_ENABLE	(1)

/* PRESSURE SENSOR */
#define SENSOR_PRESS_LABEL		"LPS22HH Pressure sensor"		// Label views in Android Applications
#define SENSOR_TEMP_LABEL		"LPS22HH Temperature sensor"		// Label views in Android Applications
#define SENSOR_DATANAME_BAROMETER	"lps22hh"				// Name of input device: struct input_dev->name
...
#define PRESS_MAX_ODR			200					// Set Max value of ODR [Hz]
